...
<div id="titulo"  class="card">
    ...
    <br>
    <a class="btn btn-primary" href="/medicos/odontologos/create">Añadir nuevo odontologo</a>
 ...
 <td>7502-1867</td>
 <td>
 <a class="btn btn-primary btn-sm" href="/medicos/odontologos/update">Modificar</a>
